...
**Do not disclose security vulnerabilities publicly until they have beenen addressed.**
...
- **FUSE Mount**: When using `avm-mount`, been aware of file system permissions.
